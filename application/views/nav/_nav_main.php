                                    ...
                                    if ($item->item_type == "category") {
                                                ...
                                                <ul class="dropdown-menu dropdown-more dropdown-top">
                                                    <?php foreach ($sub_links as $sub_item): ?>
                                                        <?php if ($sub_item->item_visibility == 1): ?>
                                                            <li>
                                                                <a role="menuitem" href="<?= generate_menu_item_url($sub_item); ?>">
                                        ...
                                        <?php else: ?>
                                            <li class="<?= (uri_string() == $item->item_slug) ? 'active' : ''; ?>">
                                                <a href="<?= generate_menu_item_url($item); ?>">
                                                    <?= html_escape($item->item_name); ?>
                                                </a>
                                            </li>
                                        <?php endif;
                                            ...
                                            if ($i >= $menu_limit):
                                                ...
                                                if (!empty($sub_links)): ?>
                                                    <li class="dropdown-more-item">
                                                        <a class="dropdown-toggle disabled" data-toggle="dropdown" href="<?= generate_menu_item_url($item); ?>">
